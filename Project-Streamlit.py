...
pages=["Introduction", "Data Exploration", "Data Vizualization","Pre-processing and Data Cleaning", "Modelling", "Prediction", "Conclusion"]
...
# Page 3 - Pre-processing and Data Cleaning
if page == pages[3] :
    st.markdown(
        """
        <style>
